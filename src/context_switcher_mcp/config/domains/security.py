...
class SecurityConfig(BaseSettings):
    ...
    def is_production_secure(self) -> bool:
        ...
        return (
            ...
            and self.enable_client_binding
            and self.enable_rate_limiting
            and self.enable_input_sanitization
            and self.signature_iterations >= 600000
        )
    ...
    def should_log_security_event(self, level: str) -> bool:
        ...
        return level_priority.get(level, 0) >= level_priority.get(
            self.security_log_level, 20
        )
