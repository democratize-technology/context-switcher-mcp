...
PERSPECTIVE_TEMPLATES = {
    "architecture_decision": {
        ...
        "custom": [
            ("scalability", "Long-term growth implications, performance at scale, "
                            "resource requirements"),
            ("team_capability", "Current team skills, learning curve, "
                               "maintenance burden"),
            ("migration", "Path from current state, backwards compatibility, "
                          "rollback strategy")
        ]
    },
    ...
    "feature_evaluation": {
        ...
        "custom": [
            ("competitive", "Market differentiation, competitor features, "
                             "unique value proposition"),
            ("support_burden", "Customer support impact, documentation needs, "
    ...
    "debugging_analysis": {
        ...
        "custom": [
            ...
            ("data_flow", "Input sources, transformations, output destinations, "
                           "data integrity"),
            ("dependencies", "External services, libraries, API calls, "
                              "version conflicts"),
    ...
    "api_design": {
        ...
        "custom": [
            ("versioning", "Breaking changes, deprecation strategy, "
                            "version maintenance"),
    ...
    "security_review": {
        ...
        "custom": [
            ("attack_surface", "Entry points, authentication, authorization, "
                                "input validation"),
